    ...
    module Adapter
      ...
      module ActiveRecord
        ...
        module Records
          ...
          #
          def records
            sql_records = klass.where(elasticsearch_id: ids)
            ...
            sql_records.instance_exec(response.response['hits']['hits']) do |hits|
              define_singleton_method :to_a do
                ...
                @records.sort_by { |record| hits.index { |hit| hit['_id'].to_s == record.elasticsearch_id.to_s } }
              end
            end
        ...
        module Importing
          ...
          def __transform
            lambda { |model|  { index: { _id: model.elasticsearch_id, data: model.__elasticsearch__.as_indexed_json } } }
          end
        end
      end
    end
